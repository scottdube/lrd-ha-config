...
|---|---|---|---|---|---|
| A | Unit #2 (Vue Gen 3, MAC `94:54:C5:6F:41:4C`) | **ESPHome (emporia-vue-panel-a.yaml), 16/16 branch CTs** | Both legs, 200A | 16/16 wired (post-remap 2026-05-12) | **Complete on ESPHome 2026-05-12 evening.** Reflashed from cloud, full locality remap applied (Vue rotated 180° from Panel B, antenna LEFT). All 16 branch CTs reading sensibly; Σ(branches) within ±1% of mains, Unmonitored Power = 0 W. All six 240V circuits (Pool Subpanel, Water Heater, Air #2 Handler, Air #1 Condenser, Mini Split, Wall Oven) reading correctly with `multiply: 2` filter. L1 voltage 122.2 V, L2 voltage 121.5 V, L2 Phase Angle 180°, frequency 60.2 Hz. Default `calibration: 0.01925` left untuned (L2 ~1.4% low — defer tuning). |
